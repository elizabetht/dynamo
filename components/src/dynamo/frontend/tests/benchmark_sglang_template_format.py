...
(ROOT / "profile.json").write_text(
    json.dumps(
        {
            "scope": "CPU full preprocessing incl real tokenization; warnings suppressed in both arms; warm template cache; source baseline loaded separately",
            "rows": rows,
            "parity": parity,
            "summary": summary,
            "imports": imports,
